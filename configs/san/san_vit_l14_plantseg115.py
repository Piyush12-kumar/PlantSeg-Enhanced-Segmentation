# ============================================================
# SAN ViT-L/14 Config for PlantSeg115 Dataset
# Optimized for single GPU (V100/A100) training on server
# ============================================================
...
# --------------- Training Schedule (160k - matches original paper) ---------------
train_cfg = dict(
...
# --------------- Optimizer (AdamW + AMP) ---------------
# accumulative_counts=2 with batch_size=2 => effective batch_size=4 (matches paper)
optim_wrapper = dict(
...
# --------------- LR Scheduler (PolyLR - matches original paper) ---------------
param_scheduler = [
    dict(
        type='PolyLR',
        eta_min=1e-4,
