# ============================================================
# Experiment 3a: Increased Queries (150)
# Hypothesis: More query proposals can capture finer-grained
# plant features, improving segmentation of small/similar classes.
# Changes: num_queries=150, sos_token_num=150 (must match)
# ============================================================
...
# --------------- Model Settings (ViT-L/14 with 150 queries) ---------------
