...
# Hypothesis: Lion optimizer is more memory-efficient and can
# converge better than AdamW for vision transformers.
# Lion uses ~3-10x smaller LR than AdamW.
# ============================================================
...
# --------------- Lion Optimizer ---------------
# Lion uses momentum-based sign update (simpler than AdamW)
# Recommended LR: 3-10x smaller than AdamW (0.0001 -> 0.00003)
# Weight decay: 3-10x larger than AdamW (0.0001 -> 0.001)
optim_wrapper = dict(
    type='AmpOptimWrapper',
    accumulative_counts=2,
    optimizer=dict(
        type='Lion', lr=0.00003, betas=(0.9, 0.99), weight_decay=0.001),
    paramwise_cfg=dict(
        custom_keys={
