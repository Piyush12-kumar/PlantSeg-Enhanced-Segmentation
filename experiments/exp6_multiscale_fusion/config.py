...
# Hypothesis: Processing CLIP features at multiple spatial
# scales captures both coarse structure and fine detail,
# improving segmentation of plants at varying sizes.
# Changes: decode_head type → MultiScaleFusionSANCLIPHead
# ============================================================
...
# --------------- Model Settings (ViT-L/14 + Multi-Scale Fusion) ---------------
...
model = dict(
    ...
    decode_head=dict(
        type='MultiScaleFusionSANCLIPHead',
        num_classes=116,
        san_cfg=dict(
            clip_channels=1024,
            scales=[1.0, 0.5],
