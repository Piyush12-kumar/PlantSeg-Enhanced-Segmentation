# ============================================================
# Experiment 3b: Increased Queries (200)
# Hypothesis: Even more queries for finer segmentation, especially
# with 116 classes (queries > num_classes may help coverage).
# Changes: num_queries=200, sos_token_num=200 (must match)
# ============================================================
...
# --------------- Model Settings (ViT-L/14 with 200 queries) ---------------
