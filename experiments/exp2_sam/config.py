...
# Hypothesis: SAM finds flatter minima → better generalization.
# Uses 1-step SAM approximation compatible with mmengine.
# ============================================================
...
# --------------- SAM Optimizer ---------------
# Uses custom SAMOptimWrapper that perturbs weights for flatter minima
# rho=0.05 is the perturbation radius
optim_wrapper = dict(
