...
# Hypothesis: Cross-attention between CLIP and spatial features
# allows selective feature integration, improving performance
# over simple addition for fine-grained plant classes.
# Changes: decode_head type → AttentionFusionSANCLIPHead
# ============================================================
...
# --------------- Model Settings (ViT-L/14 + Attention Fusion) ---------------
...
model = dict(
    ...
    decode_head=dict(
        type='AttentionFusionSANCLIPHead',
        num_classes=116,
        san_cfg=dict(
            clip_channels=1024,
            attn_heads=4,
